...
//		mav.setViewName("getBoard.jsp");
	...
	public String getBoardList(
			@RequestParam(value="searchConditon", defaultValue="TITLE", required=false)
			String conditon,
			@RequestParam(value="searchKeyword", defaultValue="", required=false)
			String keyword,		
			BoardDAO boardDAO, Model model) {
		System.out.println(">>> 게시글 전체 목록 보여주기");
		System.out.println("condition: "+conditon+", keyword: "+keyword);

//		List<BoardVO> boardList = boardDAO.getBoardList();		
		List<BoardVO> boardList = boardDAO.getBoardList(conditon,keyword);		
